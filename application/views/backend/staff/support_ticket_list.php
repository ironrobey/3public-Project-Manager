...
<table class="table table-bordered datatable" id="table_export">
	...
	<tbody>
		<?php 
		$counter	=	1;
		if ($this->crud_model->staff_permission(6) == true && $this->crud_model->staff_permission(7) == false)
			$this->db->where('assigned_staff_id' , $this->session->userdata('login_user_id'));
		...
		<tr>
			...
			<td>
				<a href="<?php echo base_url();?>index.php?staff/support_ticket_view/<?php echo $row['ticket_code'];?>">
					<?php echo $row['title'];?>
               </a>
           	</td>
