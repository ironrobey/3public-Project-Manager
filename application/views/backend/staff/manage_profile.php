        ...
        <div class="panel panel-primary" >
            ...
            <div class="panel-body">
                ...
                foreach($edit_data as $row):
                    ?>
                    <?php echo form_open('staff/manage_profile/update_profile_info' , array('class' => 'form-horizontal form-groups validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
    ...
    <div class="col-md-12">
        <div class="panel panel-primary" >
            ...
            <div class="panel-body">
                    ...
                    foreach($edit_data as $row):
                        ?>
                        <?php echo form_open('staff/manage_profile/change_password' , array('class' => 'form-horizontal form-groups validate','target'=>'_top'));?>
                            <div class="form-group">
