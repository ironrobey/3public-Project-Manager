...
<div class="row" style=" margin:100px 0px 200px;">
	...
	<div class="col-md-6" style="text-align:center;">
    	...
    	<?php if ($this->crud_model->staff_permission(4)):?>
	        <a type="button" class="btn btn-default btn-icon icon-left col-md-5 col-xs-12"  style="margin:5px;"
				href="<?php echo base_url();?>index.php?staff/staffs">
    	...
    	<?php if ($this->crud_model->staff_permission(5)):?>
	        <a type="button" class="btn btn-default btn-icon icon-left col-md-5 col-xs-12"  style="margin:5px;"
				href="<?php echo base_url();?>index.php?staff/invoice">
	        		<?php echo get_phrase('manage_payment');?>
    	...
    	<?php if ($this->crud_model->staff_permission(6)):?>
	        <a type="button" class="btn btn-default btn-icon icon-left col-md-5 col-xs-12"  style="margin:5px;"
				href="<?php echo base_url();?>index.php?staff/support_ticket/opened">
    	...
    	<?php if ($this->crud_model->staff_permission(8)):?>
	        <a type="button" class="btn btn-default btn-icon icon-left col-md-5 col-xs-12"  style="margin:5px;"
				href="<?php echo base_url();?>index.php?staff/lead">
	        		<?php echo get_phrase('lead');?>
	        			<i class="entypo-users"></i>
	        </a>
	    <?php endif;?>
