...
<div class="row">
	<div class="col-md-8">
        ...
        <!-- project tasks -->
            ...
            <!-- project calendar -->
            <div class="panel panel-primary col-md-12 col-xs-12 pull-right" style="padding:0px;">
      ...
      <div class="panel-heading">
                        ...
                        <tr>
                            ...
                            <td width="85">
                                    ...
                                    data-placement="left" data-original-title="<?php echo get_phrase('delete_file');?>"
                                    	onclick="confirm_modal('<?php echo base_url();?>index.php?staff/project_file/delete/<?php echo $row2['project_file_id'];?>' , '<?php echo base_url();?>index.php?staff/reload_project_monitor_body/<?php echo $row['project_id'];?>');">
        ...
        <!-- project discussion -->
		<div class="panel panel-primary col-md-7 col-xs-12 pull-right" data-collapsed="0"  style="padding:0px;">
			<div class="panel-heading">
			...
			<div class="panel-body" style="min-height:300px;">
				<div class="scrollable-reverse" data-height="220" data-scroll-position="right" 
                  ...
                  <?php 
                      ...
                      <div class="alert alert-default" style="margin-left:60px;">
                            <strong>
                                    <?php echo $this->db->get_where($row2['user_type'] , 
													array($row2['user_type'].'_id' => $row2['user_id']))->row()->name;?> : 
                            </strong> 
              ...
              <?php echo form_open('staff/project_message/add/'.$row['project_id'] , array('class' => 'project-message-add'));?>
                    ...
                    <div class="tile-header" style="padding:0px 0px 20px 0px;">
                        <table width="100%" border="0">
                          ...
                          <tr>
                            ...
                            <td>:</td>
                            <td>
									<?php echo $this->db->get_where('project_category',
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    <center>
                        ...
                        <a class="btn btn-success btn-icon icon-left" href="<?php echo base_url(); ?>index.php?staff/time_list/<?php echo $row['project_id']; ?>"><?php echo get_phrase('time_list'); ?>
...
<script>
  ...
  $('#project_calendar').fullCalendar({
	...
	{
		$.ajax({
			url: '<?php echo base_url();?>index.php?staff/reload_project_monitor_body/<?php echo $row['project_id'];?>',
	...
	{
		$.ajax({
			url: '<?php echo base_url();?>index.php?staff/project_task/edit/' + complete_status + '/' + project_task_id,
			success: function(response)
			{
	...
	{
		$.ajax({
			url: '<?php echo base_url();?>index.php?staff/project_task/delete/' + project_task_id,
			success: function(response)
			{
	...
	{
		$.ajax({
			url: '<?php echo base_url();?>index.php?staff/project_task_timer/edit/' + timer_status + '/' + project_id,
			success: function(response)
			{
