...
<div class="row">
				...
				<div class="panel-body" style="padding:0px;">
					...
					<!-- List of Ticket replies -->					
                        ...
                        <div class="profile-stories">
                            ...
                            <article class="story" style="padding:0px 10px 0px 20px; margin:20px 0px;">
                                <aside class="user-thumb">
                                    <a href="#">
                                        <img src="<?php echo $this->crud_model->get_image_url(
                      ...
                      <?php if ($row['status'] == 'opened'):?>
						<?php echo form_open('client/support_ticket_post_reply/'.$row['ticket_code'] , 
									array('class' => 'form-horizontal form-groups validate ticket-message-add', 
        ...
        <div class="col-md-4">
           ...
           <?php
		   if ($this->crud_model->staff_permission(7) == true):
		   ?>
...
<script>
	...
	{
		$.ajax({
			url: '<?php echo base_url();?>index.php?staff/reload_support_ticket_view_body/<?php echo $row['ticket_code'];?>',
