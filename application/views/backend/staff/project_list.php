...
<table class="table table-bordered datatable" id="table_export">
	...
	<tbody>
		...
		foreach($projects as $row):
			...
			if ($this->crud_model->staff_permission(1))		// only assigned projects of logged in staff.
			{	
		...
		<tr>
			...
			<td>
				<a href="<?php echo base_url();?>index.php?staff/project_monitor/<?php echo $row['project_id'];?>">
					<?php echo $row['title'];?>
               </a>
           	</td>
			...
			<td>
            	<a class="btn btn-info tooltip-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo get_phrase('monitor_project');?>"	href="<?php echo base_url();?>index.php?staff/project_monitor/<?php echo $row['project_id'];?>">
