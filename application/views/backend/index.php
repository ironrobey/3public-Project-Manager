<?php 
	...
	$chat_status		=	$this->db->get_where($account_type , array($account_type.'_id'=>$this->session->userdata('login_user_id')))->row()->chat_status;
...
<body class="page-body" >
	<div class="page-container 
		...
		<?php if ($chat_status == 'online') echo 'chat-visible';?> ">
