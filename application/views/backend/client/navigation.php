...
?>" alt="" class="img-circle" style="height:44px;">
    ...
    <ul id="main-menu" class="">
        ...
        <!-- PROJECT -->
        <li class="<?php if ($page_name == 'project' || $page_name == 'project_monitor' || $page_name == 'project_quote') 
        ...
        ?> ">
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'support_ticket' && $ticket_status == 'closed') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?client/support_ticket/closed">
