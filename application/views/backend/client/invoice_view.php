...
<?php if($row['status']=='unpaid'):?>
	<a href="#" class="btn btn-info btn-icon icon-left hidden-print  pull-right"
    	onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/invoice_pay/<?php echo $row['invoice_id'];?>');">
