    ...
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open('client/project_file/upload/' . $param2, array('class' => 'form-horizontal form-groups-bordered validate project-file-add', 'enctype' => 'multipart/form-data')); ?>
...
<script>
    ...
    function show_response_project_file_add(responseText, statusText, xhr, $form) {
        ...
        reload_project_monitor_body_after_project_task_add('<?php echo base_url(); ?>index.php?client/reload_project_monitor_body/<?php echo $param2; ?>');
