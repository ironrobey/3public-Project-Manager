...
foreach ($ticket_detail as $row):
    ...
    <ol class="breadcrumb bc-2">
        ...
        <li>
            <a href="<?php echo base_url(); ?>index.php?client/support_ticket/opened">
                ...
                <div class="panel-body" style="padding:0px;">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td> : </td>
                            <td>
                                <div class="label label-<?php if ($row['status'] == 'closed')
                                                            echo 'primary';
...
<script>
    ...
    {
        $.ajax({
            url: '<?php echo base_url(); ?>index.php?client/reload_support_ticket_view_body/<?php echo $row['ticket_code']; ?>',
