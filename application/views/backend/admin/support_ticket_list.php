            ...
            <td>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="#" onclick="confirm_modal('<?php echo base_url(); ?>index.php?admin/support_ticket/delete/<?php echo $row['ticket_code']; ?>', '<?php echo base_url(); ?>index.php?admin/reload_support_ticket_list/<?php echo $ticket_status;?>');" >
