...
<table class="table table-bordered datatable" id="table_export">
	...
	<tbody>
		...
		<tr>
			...
			<td>
            	<a class="btn btn-info tooltip-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo get_phrase('monitor_project');?>"	href="<?php echo base_url();?>index.php?admin/project_monitor/<?php echo $row['project_id'];?>">
              ...
              <a class="btn btn-white tooltip-primary" data-toggle="tooltip" data-placement="top" 
              		title="" data-original-title="<?php echo get_phrase('delete_project');?>" href="#" 
                    	onclick="confirm_modal('<?php echo base_url();?>index.php?admin/project/delete/<?php echo $row['project_id'];?>' , '<?php echo base_url();?>index.php?admin/reload_project_list');" >
