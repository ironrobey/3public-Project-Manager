<?php
$profile_info	=	$this->db->get_where('client' , array('client_id' => $param2))->result_array();
                ...
                <table class="table table-bordered">
                    <tr>
                        <td width="40%">
								...
								<?php echo get_phrase('total_project');?></td>
                        <td><b><?php echo $this->db->get_where('project' , array('client_id'=>$row['client_id']))->num_rows();?></b>
                        </td>
                    </tr>
