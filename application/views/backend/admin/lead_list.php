            ...
            <td>
            	...
            	<div class="btn-group">
                  ...
                  <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                      ...
                      <!-- APPROVE LINK -->
                      <li>
                          <a href="<?php echo base_url();?>index.php?admin/lead/approve/<?php echo $row['lead_id']?>"
                      ...
                      <!-- DELETION LINK -->
                      <li>
                          <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/lead/delete/<?php echo $row['lead_id'];?>' , '<?php echo base_url();?>index.php?admin/reload_lead_list');" >
...
<p style="font-weight:bold;font-style:italic;">*click on column to sort ascending or descending</p>
	...
	jQuery(document).ready(function($)
	{
		...
		var datatable = $("#table_export").dataTable({
			...
			"aoColumns": [
				...
				{ "bVisible": true, "orderSequence": [ "asc", "desc" ] },		//1,name
        { "bVisible": true},    //2,lead condition
				{ "bVisible": false},		//3,address
