    ...
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open('admin/time_list/add/'.$param2, array('class' => 'form-horizontal form-groups-bordered validate project-add', 'enctype' => 'multipart/form-data')); ?>
...
<script>
    ...
    function show_response_project_add(responseText, statusText, xhr, $form) {
        ...
        setTimeout(function(){
            window.location.href="<?php echo base_url(); ?>index.php?admin/time_list/<?php echo $param2; ?>";
        }, 1000);
