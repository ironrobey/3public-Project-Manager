                ...
                <td>
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                            ...
                            <!-- APPROVAL LINK -->
                            <li>
                                <a href="<?php echo base_url();?>index.php?admin/pending_client/approve/<?php echo $row['client_pending_id']?>"
                            ...
                            <!-- DELETION LINK -->
                            <li>
                                <a href="#" onclick="confirm_modal('<?php echo base_url(); ?>index.php?admin/pending_client/delete/<?php echo $row['client_pending_id']; ?>', '<?php echo base_url(); ?>index.php?admin/reload_pending_client_list');" >
