...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="assets/css/custom.css?ver=<?php echo rand(0, 1000); ?>">
            ...
            <div class="login-form">
                ...
                <div class="login-content">
                    ...
                    <div class="login-bottom-links">
                        ...
                        <a href="<?php echo base_url(); ?>index.php?login/create_new_account" class="link"> 
                            <i class="entypo-dot"></i>
                            <?php echo get_phrase('create_new_account'); ?>
                        </a>
