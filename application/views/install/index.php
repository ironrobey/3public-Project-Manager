...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Ekushey Project Manager Crm | web installer</title>
    ...
    <body>
    	<center><br>
        	<h1>
            	<a href="http://codecanyon.net/user/Creativeitem?ref=Creativeitem" target="_blank">
        ...
        <div id="content">
            ...
            <div id="wrapper">
                <div id="steps">
                    <?php echo form_open(base_url().'index.php?install/do_install' , array('id' => 'formElem' , 'name' => 'formElem'));?>
                        <fieldset class="step">
                        ...
                        <fieldset class="step">
                            ...
                            <p>
                            	...
                            	<a href="https://help.market.envato.com/hc/en-us/articles/202822600" target="_blank">Learn more</a>
                            </p>
                        </fieldset>
                        <fieldset class="step">
                        ...
                        <fieldset class="step">
                            ...
                            <p>
                                <label for="namecard">Site name</label>
